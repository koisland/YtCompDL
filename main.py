...
if __name__ == "__main__":
    ...
    ap.add_argument("-c", "--comment", help="Select comment.", default=False, action="store_false")
    ap.add_argument("-t", "--timestamps", help="Save timestamps as .txt file.", default=False, action="store_false")
